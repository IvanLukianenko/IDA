...
\begin{frame}
 ...
 Согласно документации признаки уже нормализированны и не нужно проводить нормализацию на этапе предобработки\\
\end{frame}
\begin{frame}
\frametitle{Сравнение моделей: синтетическая выборка}
...
\begin{itemize}
 ...
 \item На синтетических данных оправдана сложность модели, в том смысле, что более сложные модели показывают лучше качество, чем более простые. 
\end{itemize}
\end{frame}
